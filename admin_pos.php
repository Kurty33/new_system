...
<div class="sidebar" id="sidebar">
    ...
    <div class="dropdown-items" id="dropdownItems">
        ...
        <a href="admin_pos.php" class="sidebar-item active" id="viewPos">
...
<div class="content" id="content" style="position: relative;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(22%, 1fr)); gap: 20px; margin-top: 40px; padding-left: 15px; padding-right: 15px;">
        <?php
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "
                <div style='background-color: #fff; border-radius: 20px; cursor: pointer; padding: 10px; text-align: center;' 
                    onclick='openProductModal($productId, \"$imageData\", \"$productName\", \"$productPrice\", $availableQuantity)' 
                    data-bs-toggle='modal' 
                    data-bs-target='#productModal'>
                    <img src='data:image/jpeg;base64," . $imageData . "' alt='" . $productName . "' 
                        style='width: 70%; height: 150px; object-fit: cover; border-radius: 15px;' />
                    <div style='margin-top: 10px;'>
                        <h5 style=\"font-family: 'Gilroy-Bold', sans-serif;\">" . $productName . "</h5>
                        <p>₱" . $productPrice . "</p>
                    </div>
                </div>
                ";
...
<script>
    ...
    viewPos.addEventListener('click', () => {
