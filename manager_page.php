...
<div class="sidebar" id="sidebar">
    ...
    <a href="manager_page.php" class="sidebar-item active" id="dashboardItem">
        <i class="fas fa-home"></i>
        <span>Dashboard</span>
    </a>
    <a href="manager_inventory.php" class="sidebar-item" id="accountsItem">
        <i class="fas fa-box"></i>
        <span>Inventory</span>
    </a>
    <a href="manager_transac.php" class="sidebar-item" id="transactionsItem">
