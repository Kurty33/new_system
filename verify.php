...
<head>
    ...
    <link rel="stylesheet" href="css/verify.css" class="">
</head>
<body>
                                ...
                                if (isset($_SESSION["role"])) {
                                    ...
                                    switch ($role) {
                                        ...
                                        case 'Manager':
                                            ...
                                            break;
                                        case 'Cashier':
                                            echo "<script type='text/javascript'>window.location.href = 'cashier_page.php';</script>";
                                            break;
                                        case 'Inventory Staff':
                                            echo "<script type='text/javascript'>window.location.href = 'stock_page.php';</script>";
                                            break;
                                        default:
