                ...
                <div class="login-form">
                    ...
                    if (isset($_POST["submit"]) && !empty($_POST["email"]) && !empty($_POST["password"])) { // Modified if condition
                        ...
                        if (empty($email) || empty($password)) {
                            array_push($errors, "Invalid Input Value");
                        }
                            ...
                            if (mysqli_num_rows($result) == 1) {
                                ...
                                if (password_verify($password, $row["password"])) {
                                    ...
                                    try {
                                        ...
                                        $mail->Body    = 'Hello, ' . $row["firstname"] . ' ' . $row["lastname"] . '.<br>Your verification code is: <b>' . $verificationCode . '</b>';
                    ...
                    ?>
                        ...
                        <a href="confirm.php" class="forgot-password">Forgot Your Password?</a>
                    </form>
                </div>
            </div>
        </div>
